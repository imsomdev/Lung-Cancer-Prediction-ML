...
def predict():
    try:
        ...
        app.logger.info(
            f"gender: {gender}, age: {age}, smoking: {smoking}, yellowFingers: {yellowFingers}, anxiety: {anxiety}, peerPressure: {peerPressure}, chronicDisease: {chronicDisease}, fatigue: {fatigue}, allergy: {allergy}, wheezing: {wheezing}, alcoholConsuming: {alcoholConsuming}, coughing: {coughing}, shortnessOfBreathe: {shortnessOfBreathe}, swallowingDifficulty: {swallowingDifficulty}, chestPain: {chestPain}"
        )
